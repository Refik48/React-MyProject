...
const Clock3 = (props) => {
  const [dateTime, setDateTime] = useState(
    moment()
  ); /* ilkel degisken olan  const dateTime = moment(); 'i  useState yaptik.*/
  ...
  /*Calistirmak icin burayi yapiyoruz. Bunun icin setTimeout Kodunu kullaniyoruz. */
  //  setTimeout( ()=> {
  //  console.log("Merhaba"); /* bu kod 1 sn bekler ve bir defa calistir*/
  //  },1000);
  ...
  useEffect(() => {
    ...
    const sayac = setInterval(() => {
      ...
      setDateTime(
        moment()
      ); /* (ilk yazim) bu kod 1 sn bekler ve calistir sonra 1 sn bekler calistir ve biz durdurana kadar (clearInterval ile) bu devam eder.*/
    }, 1000);
